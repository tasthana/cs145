...
?>
        ...
        <main>
            ...
            <section>
                ...
                <p>
                My travel website was the result of a final project assignment in my CS 008 class (Intro to Website Development). This site featured 
            ...
            <section>
                <h2>PyCharm Robot</h2>
                <p>
                My final project for CS 206 (Evolutionary Robotics) was a PyCharm Robot. Using PyCharm to simulate the effects of Earth's gravity, 
                I coded a robot using Python. Written in over a 1000 lines of code were the robots brain, body, and neurons and sensors that allowed 
